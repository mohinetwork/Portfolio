...
export default function Reachout({
  ...
  socialLinks = {
    ...
    mail: "mailto:safexera@gmail.com",
  }
}: ReachoutProps) {
  return (
        ...
        <div className="flex justify-center sm:justify-start gap-3 sm:gap-3">
          ...
          {socialLinks.instagram && (
            <Tooltip content={
              ...
              >
                <FaInstagram className="text-[28px] sm:text-[18px] text-black/75 dark:text-white/80 shrink-0" />
                <span className="hidden sm:inline text-sm font-medium text-black/75 dark:text-white/80">Instagram</span>
              </a>
            </Tooltip>
          )}
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-800">
          <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
            <div className="text-sm dark:text-white/50 text-black/50 text-center sm:text-left">
              <p>Design & Developed by <span className="font-medium text-black/70 dark:text-white/70">mohit ❤️</span></p>
